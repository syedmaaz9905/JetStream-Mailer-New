...
const OptionInformationContent2 = () => {
    ...
    return (
        <View>
            ...
            <View style={{ flexDirection: 'column', alignItems: 'center', marginTop: 16, justifyContent: 'center', backgroundColor: '#ededed', borderRadius: 10, padding: 8, width: 700 }}>
...
export default OptionInformationContent2